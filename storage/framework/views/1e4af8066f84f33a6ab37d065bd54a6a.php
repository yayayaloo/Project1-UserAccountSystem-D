...
<head>
    ...
    <title>Add Student - Student Grade Tracker</title>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['student_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       id="student_number" name="student_number" value="<?php echo e(old('student_number')); ?>" required>
...
</html><?php /**PATH C:\IT-ELECTIVE 3 PROJECT\resources\views/students/create.blade.php ENDPATH**/ ?>